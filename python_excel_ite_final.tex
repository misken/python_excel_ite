...
\begin{figure}[!htbp]
\includegraphics[width=1.0\textwidth]{images/output_2_0}
...
\begin{figure}[!htbp]
\centering
\includegraphics[scale=0.5]{images/function_datatable}
...
\begin{figure}[!htbp]
\centering
\includegraphics[scale=0.5]{images/datatable_scatter}
