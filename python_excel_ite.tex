...
\begin{itemize}
	...
	\item there's a known unit cost for each one ordered,
...
The notebook begins with a suggestion to start with a very simple model that ignores the demand uncertainty and that is not object oriented. Proceeding much like we would in Excel, we store base input values in variables. (unit cost, unit price, selling prce, unit refund and demand)
