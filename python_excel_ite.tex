...
Spreadsheet based modeling has transformed the teaching of management science in business schools. The late 1990's saw the first editions of game changing textbooks \cite{ } focused on the use of spreadsheets in teaching modeling and management science.  A series of conferences focused on teaching management science (TMS) with spreadsheets started at Dartmouth in 1998 and several presentations from that conference made up the bulk of papers in the first two issues of the INFORMS Transactions on Education journal \cite{bibid}. I attended TMS III at Indiana University and left with numerous ideas that influenced my own spreadsheet based modeling course. The next few decades saw numerous textbooks and teaching papers that prominently featured spreadsheet based modeling.
