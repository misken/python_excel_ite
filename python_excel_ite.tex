...
\RUNTITLE{Spreadsheet-ish modeling with Python}

% Full title. Sample:
% \TITLE{Bundling Information Goods of Decreasing Value}
% Enter the full title:
\TITLE{Spreadsheet-ish modeling with Python}
...
\begin{figure}[!htbp]
	\centering
	\includegraphics[scale=0.5]{images/function_datatable.png}
...
\begin{figure}[!htbp]
	\centering
	\includegraphics[scale=0.5]{images/datatable_scatter.png}
