...
Numerous R and Python based data science courses have been developed and offered at universities and online learning platforms such as Coursera, EdX, Udemy and others. Some of these courses have made a large amount of their course content freely available for self-learners and for other educators. At our institution, we created a course called Practical Computing for Data Analytics (PCDA) in 2015 that introduced both R and Python (along with a little Linux) for use in data analytics work. The course is taught using combination of R Markdown documents \cite{bibid} and Jupyter notebooks \cite{bibid}. All of the course content is freely available from a publicly accessible course web site \url{URL}.
