...
Despite numerous calls for and predictions of the eradication of spreadsheets from the business world, Google "spreadsheets are evil"

Excel not a database and shouldn't be used as one. There are better data visualizaiton and exploration tools. There are better dashboarding tools. Spreadsheet errors are a huge problem. Version control and documentation issues. Data size limitations. External link problems. But, spreadsheets are still very well suited to what if type modeling due to their flexibility, numerous built in functions, integrated visualization capabilities and ubiquity
