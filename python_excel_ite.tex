...
\begin{thebibliography}{29}
	...
	\bibitem[{Albright \protect\BIBand{}
		Winston(2016)}]{albrightBusinessAnalyticsData2016}
	Albright SC, Winston WL (2016) \emph{Business {{Analytics}}: {{Data Analysis}}
		\& {{Decision Making}} - {{Standalone}} Book} ({Boston, MA}: {Cengage
		Learning}), 6th edition edition, ISBN 978-1-305-94754-2.
	
	\bibitem[{{Audrey Roy and Cookiecutter
			community}(2012)}]{audreyroyandcookiecuttercommunityCookiecutterBetterProject2012}
	{Audrey Roy and Cookiecutter community} (2012) \emph{Cookiecutter: {{Better}}
		Project Templates}.
	
	\bibitem[{Barba et~al.(2019)Barba, Barker, Blank, Brown, Downey, George, Heagy,
		Mandli, Moore, Lippert et~al.}]{barba2019teaching}
	Barba LA, Barker LJ, Blank DS, Brown J, Downey AB, George T, Heagy LJ, Mandli
	KT, Moore JK, Lippert D, et~al. (2019) Teaching and learning with
	{{Jupyter}}. \emph{Recuperado: https://jupyter4edu. github.
		io/jupyter-edu-book} .
	
	\bibitem[{Buezen \protect\BIBand{}
		Timbers(2022)}]{buezenWelcomePythonPackages2022}
	Buezen T, Timbers T (2022) Welcome to {{Python Packages}}! \textemdash{}
	{{Python Packages}}. https://py-pkgs.org/.
	
	\bibitem[{Camm et~al.(2020)Camm, Cochran, Fry, \protect\BIBand{}
		Ohlmann}]{camm2020business}
	Camm JD, Cochran JJ, Fry MJ, Ohlmann JW (2020) \emph{Business Analytics}
	({Cengage Learning}).
	
	\bibitem[{Canny(2013)}]{cannyPythonpptx2013}
	Canny S (2013) Python-pptx. https://python-pptx.readthedocs.io/en/latest/.
	
	\bibitem[{Cimpanu(2017)}]{cimpanuMicrosoftConsidersAdding2017}
	Cimpanu C (2017) Microsoft {{Considers Adding Python}} as an {{Official
			Scripting Language}} to {{Excel}}.
	...
	\bibitem[{Grus(2018)}]{grusDonNotebooks2018}
	Grus J (2018) I don't like notebooks ({JupyterCon 2018 (New York)}).
	...
	\bibitem[{Harris et~al.(2020)Harris, Millman, {van der Walt}, Gommers,
		...
		\protect\BIBand{} Oliphant}]{harris2020array}
	Harris CR, Millman KJ, {van der Walt} SJ, Gommers R, Virtanen P, Cournapeau D,
	Wieser E, Taylor J, Berg S, Smith NJ, Kern R, Picus M, Hoyer S, {van
		Kerkwijk} MH, Brett M, Haldane A, {del R{\'i}o} JF, Wiebe M, Peterson P,
	{G{\'e}rard-Marchant} P, Sheppard K, Reddy T, Weckesser W, Abbasi H, Gohlke
	C, Oliphant TE (2020) Array programming with {{NumPy}}. \emph{Nature}
	585(7825):357--362,
	\urlprefix\url{http://dx.doi.org/10.1038/s41586-020-2649-2}.
	
	\bibitem[{Johnson(2020)}]{johnson2020benefits}
	Johnson JW (2020) Benefits and pitfalls of jupyter notebooks in the classroom.
	\emph{Proceedings of the 21st Annual Conference on Information Technology
		Education}, 32--37.
	
	\bibitem[{{Jupyter Team}(2015)}]{jupyterteamProjectJupyterDocumentation2015}
	{Jupyter Team} (2015) Project jupyter documentation.
	https://docs.jupyter.org/en/latest/.
	
	\bibitem[{McKinney(2022)}]{mckinney2022python}
	McKinney W (2022) \emph{Python for Data Analysis} ({O'Reilly}).
	
	\bibitem[{Moffitt(2022)}]{moffittPracticalBusinessPython2022}
	Moffitt C (2022) Practical {{Business Python}}. https://pbpython.com/.
	
	\bibitem[{Nelson(2024)}]{nelsonSoftwareEngineeringData2024}
	Nelson C (2024) \emph{Software {{Engineering}} for {{Data Scientists}}}
	({O'Reilly}), ISBN 978-1-09-813619-2.
	...
	\bibitem[{Pedregosa et~al.(2011)Pedregosa, Varoquaux, Gramfort, Michel,
		...
		Cournapeau, Brucher, Perrot, \protect\BIBand{} Duchesnay}]{scikit-learn}
	...
	\bibitem[{Perez \protect\BIBand{} Granger(2015)}]{perez2015project}
	Perez F, Granger BE (2015) Project {{Jupyter}}: {{Computational}} narratives as
	the engine of collaborative data science. \emph{Retrieved September}
	11(207):108.
	
	\bibitem[{Perkel(2018)}]{perkel2018jupyter}
	Perkel JM (2018) Why {{Jupyter}} is data scientists' computational notebook of
	choice. \emph{Nature} 563(7732):145--147.
	
	\bibitem[{Powell(2001)}]{powellTeachingModelingManagement2001}
	Powell SG (2001) Teaching {{Modeling}} in {{Management Science}}. \emph{INFORMS
		Transactions on Education} 1(2):62--67, ISSN 1532-0545,
	\urlprefix\url{http://dx.doi.org/10.1287/ited.1.2.62}.
	
	\bibitem[{Powell \protect\BIBand{}
		Baker(2019)}]{powellBusinessAnalyticsArt2019}
	Powell SG, Baker KR (2019) \emph{Business {{Analytics}}: {{The Art}} of
		{{Modeling With Spreadsheets}}, 5th {{Edition}} | {{Wiley}}}.
	
	\bibitem[{Ragsdale(2017)}]{ragsdaleSpreadsheetModelingDecision2017}
	Ragsdale C (2017) \emph{Spreadsheet {{Modeling}} \& {{Decision Analysis}}: {{A
				Practical Introduction}} to {{Business Analytics}}} ({Australia}: {Cengage
		Learning}), 8th edition edition, ISBN 978-1-305-94741-2.
	
	\bibitem[{Rodrigues(2023)}]{rodriguesBuildingReproducibleAnalytical2023}
	Rodrigues B (2023) Building reproducible analytical pipelines with {{R}}.
	https://raps-with-r.dev/.
	
	\bibitem[{Rule et~al.(2018)Rule, Birmingham, Zuniga, Altintas, Huang, Knight,
		Moshiri, Nguyen, Rosenthal, P{\'e}rez et~al.}]{rule2018ten}
	Rule A, Birmingham A, Zuniga C, Altintas I, Huang SC, Knight R, Moshiri N,
	Nguyen MH, Rosenthal SB, P{\'e}rez F, et~al. (2018) Ten simple rules for
	reproducible research in {{Jupyter}} notebooks. \emph{arXiv preprint
		arXiv:1810.08055} .
	
	\bibitem[{Savage(2012)}]{savageFlawAveragesWhy2012}
	Savage SL (2012) \emph{The {{Flaw}} of {{Averages}}: {{Why We Underestimate
				Risk}} in the {{Face}} of {{Uncertainty}}} ({Hoboken, New Jersey}: {Wiley}),
	1st edition edition, ISBN 978-1-118-07375-9.
	
	\bibitem[{Treadway(2023)}]{treadwaySoftwareEngineeringData2023}
	Treadway A (2023) \emph{Software {{Engineering}} for {{Data Scientists}}}
	({Manning}).
	
	\bibitem[{Ufford et~al.(2019)Ufford, {Pacer, M}, {Seal, Matthew},
		\protect\BIBand{} {Kelley, Kyle}}]{uffordInteractiveNotebookInnovation2019}
	Ufford M, {Pacer, M}, {Seal, Matthew}, {Kelley, Kyle} (2019) Beyond
	{{Interactive}}: {{Notebook Innovation}} at {{Netflix}}.
	...
	\bibitem[{Virtanen et~al.(2020)Virtanen, Gommers, Oliphant, Haberland, Reddy,
		...
		Archibald, Ribeiro, Pedregosa, {van Mulbregt}, \protect\BIBand{} {SciPy 1.0
	...
	Wilson J, Millman KJ, Mayorov N, Nelson ARJ, Jones E, Kern R, Larson E, Carey
	CJ, Polat {\.I}, Feng Y, Moore EW, VanderPlas J, Laxalde D, Perktold J,
	Cimrman R, Henriksen I, Quintero EA, Harris CR, Archibald AM, Ribeiro AH,
	Pedregosa F, {van Mulbregt} P, {SciPy 10 Contributors} (2020) {{SciPy}} 1.0:
	{{Fundamental}} algorithms for scientific computing in python. \emph{Nature
		Methods} 17:261--272,
	\urlprefix\url{http://dx.doi.org/10.1038/s41592-019-0686-2}.
	
	\bibitem[{Walls(2023)}]{wallsMathematicalPython2023}
	Walls P (2023) Mathematical {{Python}}.
	https://github.com/patrickwalls/mathematicalpython.
	
	\bibitem[{Wickham(2014)}]{wickhamTidyData2014}
	Wickham H (2014) Tidy {{Data}}. \emph{Journal of Statistical Software}
	59:1--23, ISSN 1548-7660,
	\urlprefix\url{http://dx.doi.org/10.18637/jss.v059.i10}.
	
	\bibitem[{Winston \protect\BIBand{}
		Albright(2018)}]{winstonPracticalManagementScience2018}
	Winston WL, Albright SC (2018) \emph{Practical {{Management Science}}}
	({Australia ; Boston, MA}: {Cengage Learning}), 6th edition edition, ISBN
	978-1-337-40665-9.
