...
For the remote repository, make a github repository named python_excel_ite, then do;

```bash
git remote add origin git@github.com:misken/python_excel_ite.git
git branch -M main
...
Here's the folder structure that gets created by `cookiecutter-datascience-simple`:
	...
	├── python_excel_ite	<- Your notebooks and scripts will live in the main project folder
